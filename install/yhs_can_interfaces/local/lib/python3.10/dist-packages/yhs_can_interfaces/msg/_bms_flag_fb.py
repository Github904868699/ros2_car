    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'yhs_can_interfaces.msg.BmsFlagFb')
            logger.debug(
...
class BmsFlagFb(metaclass=Metaclass_BmsFlagFb):
    ...
    _fields_and_field_types = {
        ...
        'bms_flag_fb_heating_flag': 'boolean',
    ...
    def __init__(self, **kwargs):
        ...
        self.bms_flag_fb_heating_flag = kwargs.get('bms_flag_fb_heating_flag', bool())
    ...
    def __eq__(self, other):
        ...
        if self.bms_flag_fb_charge_flag != other.bms_flag_fb_charge_flag:
            return False
        if self.bms_flag_fb_heating_flag != other.bms_flag_fb_heating_flag:
            return False
    ...
    @builtins.property
    def bms_flag_fb_heating_flag(self):
        """Message field 'bms_flag_fb_heating_flag'."""
        return self._bms_flag_fb_heating_flag

    @bms_flag_fb_heating_flag.setter
    def bms_flag_fb_heating_flag(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'bms_flag_fb_heating_flag' field must be of type 'bool'"
        self._bms_flag_fb_heating_flag = value
    ...
    def bms_flag_fb_hight_temperature(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'bms_flag_fb_hight_temperature' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def bms_flag_fb_low_temperature(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'bms_flag_fb_low_temperature' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
