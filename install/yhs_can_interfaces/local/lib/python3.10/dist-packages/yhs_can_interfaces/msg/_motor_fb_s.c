...
bool yhs_can_interfaces__msg__motor_fb__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yhs_can_interfaces.msg._motor_fb.MotorFb", full_classname_dest, 40) == 0);
  }
  yhs_can_interfaces__msg__MotorFb * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of MotorFb */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("yhs_can_interfaces.msg._motor_fb");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MotorFb");
