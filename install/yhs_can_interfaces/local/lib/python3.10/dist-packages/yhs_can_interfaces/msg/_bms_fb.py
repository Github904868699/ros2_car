...
class BmsFb(metaclass=Metaclass_BmsFb):
    ...
    def bms_fb_voltage(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'bms_fb_voltage' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def bms_fb_current(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'bms_fb_current' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def bms_fb_remaining_capacity(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'bms_fb_remaining_capacity' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
