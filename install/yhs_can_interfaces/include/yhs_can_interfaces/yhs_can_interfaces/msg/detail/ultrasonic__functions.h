...
#ifndef YHS_CAN_INTERFACES__MSG__DETAIL__ULTRASONIC__FUNCTIONS_H_
#define YHS_CAN_INTERFACES__MSG__DETAIL__ULTRASONIC__FUNCTIONS_H_
 ...
 * calls
 * yhs_can_interfaces__msg__Ultrasonic__init().
...
/**
 * It calls
 * yhs_can_interfaces__msg__Ultrasonic__fini()
 ...
 * yhs_can_interfaces__msg__Ultrasonic__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * yhs_can_interfaces__msg__Ultrasonic__Sequence__fini()
 * on the array,
...
#endif  // YHS_CAN_INTERFACES__MSG__DETAIL__ULTRASONIC__FUNCTIONS_H_
