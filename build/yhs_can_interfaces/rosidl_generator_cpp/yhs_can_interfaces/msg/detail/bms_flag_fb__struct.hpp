...
#ifndef YHS_CAN_INTERFACES__MSG__DETAIL__BMS_FLAG_FB__STRUCT_HPP_
#define YHS_CAN_INTERFACES__MSG__DETAIL__BMS_FLAG_FB__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__yhs_can_interfaces__msg__BmsFlagFb __attribute__((deprecated))
#else
# define DEPRECATED__yhs_can_interfaces__msg__BmsFlagFb __declspec(deprecated)
#endif
...
struct BmsFlagFb_
{
  ...
  explicit BmsFlagFb_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->bms_flag_fb_heating_flag = false;
  ...
  using _bms_flag_fb_heating_flag_type =
    bool;
  _bms_flag_fb_heating_flag_type bms_flag_fb_heating_flag;
  ...
  Type & set__bms_flag_fb_heating_flag(
    const bool & _arg)
  {
    this->bms_flag_fb_heating_flag = _arg;
    return *this;
  }
  ...
  using ConstRawPtr =
    const yhs_can_interfaces::msg::BmsFlagFb_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<yhs_can_interfaces::msg::BmsFlagFb_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<yhs_can_interfaces::msg::BmsFlagFb_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      yhs_can_interfaces::msg::BmsFlagFb_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<yhs_can_interfaces::msg::BmsFlagFb_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<yhs_can_interfaces::msg::BmsFlagFb_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<yhs_can_interfaces::msg::BmsFlagFb_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<yhs_can_interfaces::msg::BmsFlagFb_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__yhs_can_interfaces__msg__BmsFlagFb
    std::shared_ptr<yhs_can_interfaces::msg::BmsFlagFb_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__yhs_can_interfaces__msg__BmsFlagFb
    std::shared_ptr<yhs_can_interfaces::msg::BmsFlagFb_<ContainerAllocator> const>
  ...
  bool operator==(const BmsFlagFb_ & other) const
  {
    ...
    if (this->bms_flag_fb_heating_flag != other.bms_flag_fb_heating_flag) {
      return false;
    }
...
using BmsFlagFb =
  yhs_can_interfaces::msg::BmsFlagFb_<std::allocator<void>>;
...
#endif  // YHS_CAN_INTERFACES__MSG__DETAIL__BMS_FLAG_FB__STRUCT_HPP_
