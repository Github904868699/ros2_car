...
struct CtrlCmd_
{
  ...
  explicit CtrlCmd_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->ctrl_cmd_x_linear = 0.0f;
      this->ctrl_cmd_z_angular = 0.0f;
      this->ctrl_cmd_y_linear = 0.0f;
    }
  }
  ...
  using _ctrl_cmd_x_linear_type =
    float;
  _ctrl_cmd_x_linear_type ctrl_cmd_x_linear;
  using _ctrl_cmd_z_angular_type =
    float;
  _ctrl_cmd_z_angular_type ctrl_cmd_z_angular;
  using _ctrl_cmd_y_linear_type =
    float;
  ...
  Type & set__ctrl_cmd_x_linear(
    const float & _arg)
  {
    this->ctrl_cmd_x_linear = _arg;
    return *this;
  }
  Type & set__ctrl_cmd_z_angular(
    const float & _arg)
  {
    this->ctrl_cmd_z_angular = _arg;
    return *this;
  }
  Type & set__ctrl_cmd_y_linear(
    const float & _arg)
  {
    this->ctrl_cmd_y_linear = _arg;
    return *this;
  }
  ...
  bool operator==(const CtrlCmd_ & other) const
  {
    ...
    if (this->ctrl_cmd_x_linear != other.ctrl_cmd_x_linear) {
      return false;
    }
    if (this->ctrl_cmd_z_angular != other.ctrl_cmd_z_angular) {
      return false;
    }
    if (this->ctrl_cmd_y_linear != other.ctrl_cmd_y_linear) {
      return false;
    }
    return true;
  }
