  ...
  std::ostream & out)
{
  ...
  {
    out << "ctrl_cmd_x_linear: ";
    rosidl_generator_traits::value_to_yaml(msg.ctrl_cmd_x_linear, out);
    out << ", ";
  }

  // member: ctrl_cmd_z_angular
  {
    out << "ctrl_cmd_z_angular: ";
    rosidl_generator_traits::value_to_yaml(msg.ctrl_cmd_z_angular, out);
    out << ", ";
  }

  // member: ctrl_cmd_y_linear
  {
    out << "ctrl_cmd_y_linear: ";
    rosidl_generator_traits::value_to_yaml(msg.ctrl_cmd_y_linear, out);
  }
  out << "}";
