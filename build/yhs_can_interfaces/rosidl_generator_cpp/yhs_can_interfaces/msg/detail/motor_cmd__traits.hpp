...
#ifndef YHS_CAN_INTERFACES__MSG__DETAIL__MOTOR_CMD__TRAITS_HPP_
#define YHS_CAN_INTERFACES__MSG__DETAIL__MOTOR_CMD__TRAITS_HPP_
...
inline void to_yaml(
  const yhs_can_interfaces::msg::MotorCmd & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const yhs_can_interfaces::msg::MotorCmd & msg)
{
  return yhs_can_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<yhs_can_interfaces::msg::MotorCmd>()
{
  return "yhs_can_interfaces::msg::MotorCmd";
}

template<>
inline const char * name<yhs_can_interfaces::msg::MotorCmd>()
{
  return "yhs_can_interfaces/msg/MotorCmd";
}

template<>
struct has_fixed_size<yhs_can_interfaces::msg::MotorCmd>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<yhs_can_interfaces::msg::MotorCmd>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<yhs_can_interfaces::msg::MotorCmd>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // YHS_CAN_INTERFACES__MSG__DETAIL__MOTOR_CMD__TRAITS_HPP_
