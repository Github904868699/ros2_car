...
#include "yhs_can_interfaces/msg/detail/bms_fb__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yhs_can_interfaces::msg::BmsFb & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yhs_can_interfaces::msg::BmsFb & ros_message)
{
  // Member: bms_fb_voltage
  cdr >> ros_message.bms_fb_voltage;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yhs_can_interfaces::msg::BmsFb;
    is_plain =
      (
      offsetof(DataType, bms_fb_remaining_capacity) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const yhs_can_interfaces::msg::BmsFb *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yhs_can_interfaces::msg::BmsFb *>(
    untyped_ros_message);
...
{
  return &yhs_can_interfaces::msg::typesupport_fastrtps_cpp::_BmsFb__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yhs_can_interfaces, msg, BmsFb)() {
  return &yhs_can_interfaces::msg::typesupport_fastrtps_cpp::_BmsFb__handle;
}
