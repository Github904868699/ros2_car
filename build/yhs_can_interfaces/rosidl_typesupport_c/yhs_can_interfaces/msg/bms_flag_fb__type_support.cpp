...
static const _BmsFlagFb_type_support_symbol_names_t _BmsFlagFb_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yhs_can_interfaces, msg, BmsFlagFb)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yhs_can_interfaces, msg, BmsFlagFb)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, yhs_can_interfaces, msg, BmsFlagFb)() {
  return &::yhs_can_interfaces::msg::rosidl_typesupport_c::BmsFlagFb_message_type_support_handle;
}
