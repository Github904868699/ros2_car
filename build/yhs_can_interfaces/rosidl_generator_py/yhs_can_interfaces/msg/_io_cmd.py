...
class IoCmd(metaclass=Metaclass_IoCmd):
    ...
    __slots__ = [
        ...
        '_io_cmd_fog_lamp',
        '_io_cmd_speaker',
        '_io_cmd_low_power_ratio',
    ]

    _fields_and_field_types = {
        'io_cmd_lamp_ctrl': 'boolean',
        'io_cmd_unlock': 'boolean',
        'io_cmd_low_power_enable': 'boolean',
    ...
    def __init__(self, **kwargs):
        ...
        self.io_cmd_low_power_enable = kwargs.get('io_cmd_low_power_enable', bool())
        ...
        self.io_cmd_low_power_ratio = kwargs.get('io_cmd_low_power_ratio', int())
    ...
    def __eq__(self, other):
        ...
        if self.io_cmd_unlock != other.io_cmd_unlock:
            return False
        if self.io_cmd_low_power_enable != other.io_cmd_low_power_enable:
            return False
        ...
        if self.io_cmd_speaker != other.io_cmd_speaker:
            return False
        if self.io_cmd_low_power_ratio != other.io_cmd_low_power_ratio:
            return False
        return True
    ...
    @builtins.property
    def io_cmd_low_power_enable(self):
        """Message field 'io_cmd_low_power_enable'."""
        return self._io_cmd_low_power_enable

    @io_cmd_low_power_enable.setter
    def io_cmd_low_power_enable(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'io_cmd_low_power_enable' field must be of type 'bool'"
        self._io_cmd_low_power_enable = value
    ...
    @builtins.property
    def io_cmd_low_power_ratio(self):
        """Message field 'io_cmd_low_power_ratio'."""
        return self._io_cmd_low_power_ratio

    @io_cmd_low_power_ratio.setter
    def io_cmd_low_power_ratio(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'io_cmd_low_power_ratio' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'io_cmd_low_power_ratio' field must be an unsigned integer in [0, 255]"
        self._io_cmd_low_power_ratio = value
