...
class IoFb(metaclass=Metaclass_IoFb):
    ...
    __slots__ = [
        '_io_fb_lamp_ctrl',
        '_io_fb_unlock',
        '_io_fb_low_power_enable',
        '_io_fb_low_power_state',
        ...
        '_io_fb_charger_sign',
        '_io_fb_joypad_first',
        '_io_fb_joypad_online',
    ]

    _fields_and_field_types = {
        'io_fb_lamp_ctrl': 'boolean',
        'io_fb_unlock': 'boolean',
        'io_fb_low_power_enable': 'boolean',
        'io_fb_low_power_state': 'boolean',
        ...
        'io_fb_charger_sign': 'boolean',
        'io_fb_joypad_first': 'boolean',
        'io_fb_joypad_online': 'boolean',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.io_fb_low_power_enable = kwargs.get('io_fb_low_power_enable', bool())
        self.io_fb_low_power_state = kwargs.get('io_fb_low_power_state', bool())
        ...
        self.io_fb_low_power_ratio = kwargs.get('io_fb_low_power_ratio', int())
        ...
        self.io_fb_charger_sign = kwargs.get('io_fb_charger_sign', bool())
        self.io_fb_joypad_first = kwargs.get('io_fb_joypad_first', bool())
        self.io_fb_joypad_online = kwargs.get('io_fb_joypad_online', bool())
    ...
    def __eq__(self, other):
        ...
        if self.io_fb_unlock != other.io_fb_unlock:
            return False
        if self.io_fb_low_power_enable != other.io_fb_low_power_enable:
            return False
        if self.io_fb_low_power_state != other.io_fb_low_power_state:
            return False
        ...
        if self.io_fb_speaker != other.io_fb_speaker:
            return False
        if self.io_fb_low_power_ratio != other.io_fb_low_power_ratio:
            return False
        ...
        if self.io_fb_charge_state != other.io_fb_charge_state:
            return False
        if self.io_fb_charger_sign != other.io_fb_charger_sign:
            return False
        if self.io_fb_joypad_first != other.io_fb_joypad_first:
            return False
        if self.io_fb_joypad_online != other.io_fb_joypad_online:
            return False
        return True
    ...
    @builtins.property
    def io_fb_low_power_enable(self):
        """Message field 'io_fb_low_power_enable'."""
        return self._io_fb_low_power_enable

    @io_fb_low_power_enable.setter
    def io_fb_low_power_enable(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'io_fb_low_power_enable' field must be of type 'bool'"
        self._io_fb_low_power_enable = value

    @builtins.property
    def io_fb_low_power_state(self):
        """Message field 'io_fb_low_power_state'."""
        return self._io_fb_low_power_state

    @io_fb_low_power_state.setter
    def io_fb_low_power_state(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'io_fb_low_power_state' field must be of type 'bool'"
        self._io_fb_low_power_state = value
    ...
    @builtins.property
    def io_fb_low_power_ratio(self):
        """Message field 'io_fb_low_power_ratio'."""
        return self._io_fb_low_power_ratio

    @io_fb_low_power_ratio.setter
    def io_fb_low_power_ratio(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'io_fb_low_power_ratio' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'io_fb_low_power_ratio' field must be an unsigned integer in [0, 255]"
        self._io_fb_low_power_ratio = value
    ...
    @builtins.property
    def io_fb_charger_sign(self):
        """Message field 'io_fb_charger_sign'."""
        return self._io_fb_charger_sign

    @io_fb_charger_sign.setter
    def io_fb_charger_sign(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'io_fb_charger_sign' field must be of type 'bool'"
        self._io_fb_charger_sign = value

    @builtins.property
    def io_fb_joypad_first(self):
        """Message field 'io_fb_joypad_first'."""
        return self._io_fb_joypad_first

    @io_fb_joypad_first.setter
    def io_fb_joypad_first(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'io_fb_joypad_first' field must be of type 'bool'"
        self._io_fb_joypad_first = value

    @builtins.property
    def io_fb_joypad_online(self):
        """Message field 'io_fb_joypad_online'."""
        return self._io_fb_joypad_online

    @io_fb_joypad_online.setter
    def io_fb_joypad_online(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'io_fb_joypad_online' field must be of type 'bool'"
        self._io_fb_joypad_online = value
