...
bool yhs_can_interfaces__msg__io_fb__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // io_fb_low_power_enable
    PyObject * field = PyObject_GetAttrString(_pymsg, "io_fb_low_power_enable");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->io_fb_low_power_enable = (Py_True == field);
    Py_DECREF(field);
  }
  {  // io_fb_low_power_state
    PyObject * field = PyObject_GetAttrString(_pymsg, "io_fb_low_power_state");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->io_fb_low_power_state = (Py_True == field);
    Py_DECREF(field);
  }
  ...
  {  // io_fb_low_power_ratio
    PyObject * field = PyObject_GetAttrString(_pymsg, "io_fb_low_power_ratio");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->io_fb_low_power_ratio = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  ...
  {  // io_fb_charger_sign
    PyObject * field = PyObject_GetAttrString(_pymsg, "io_fb_charger_sign");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->io_fb_charger_sign = (Py_True == field);
    Py_DECREF(field);
  }
  {  // io_fb_joypad_first
    PyObject * field = PyObject_GetAttrString(_pymsg, "io_fb_joypad_first");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->io_fb_joypad_first = (Py_True == field);
    Py_DECREF(field);
  }
  {  // io_fb_joypad_online
    PyObject * field = PyObject_GetAttrString(_pymsg, "io_fb_joypad_online");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->io_fb_joypad_online = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * yhs_can_interfaces__msg__io_fb__convert_to_py(void * raw_ros_message)
{
  ...
  {  // io_fb_low_power_enable
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->io_fb_low_power_enable ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "io_fb_low_power_enable", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // io_fb_low_power_state
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->io_fb_low_power_state ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "io_fb_low_power_state", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // io_fb_low_power_ratio
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->io_fb_low_power_ratio);
    {
      int rc = PyObject_SetAttrString(_pymessage, "io_fb_low_power_ratio", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // io_fb_charger_sign
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->io_fb_charger_sign ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "io_fb_charger_sign", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // io_fb_joypad_first
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->io_fb_joypad_first ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "io_fb_joypad_first", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // io_fb_joypad_online
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->io_fb_joypad_online ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "io_fb_joypad_online", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
