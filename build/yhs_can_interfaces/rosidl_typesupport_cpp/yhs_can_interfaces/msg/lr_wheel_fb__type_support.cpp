...
static const _LrWheelFb_type_support_symbol_names_t _LrWheelFb_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yhs_can_interfaces, msg, LrWheelFb)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yhs_can_interfaces, msg, LrWheelFb)),
  }
};
...
{
  return &::yhs_can_interfaces::msg::rosidl_typesupport_cpp::LrWheelFb_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, yhs_can_interfaces, msg, LrWheelFb)() {
  return get_message_type_support_handle<yhs_can_interfaces::msg::LrWheelFb>();
}
