...
#include "yhs_can_interfaces/msg/detail/motor_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _MotorCmd__ros_msg_type = yhs_can_interfaces__msg__MotorCmd;
...
size_t get_serialized_size_yhs_can_interfaces__msg__MotorCmd(
  const void * untyped_ros_message,
...
static uint32_t _MotorCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yhs_can_interfaces__msg__MotorCmd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yhs_can_interfaces
size_t max_serialized_size_yhs_can_interfaces__msg__MotorCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yhs_can_interfaces__msg__MotorCmd;
    is_plain =
      (
...
static size_t _MotorCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yhs_can_interfaces__msg__MotorCmd(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yhs_can_interfaces, msg, MotorCmd)() {
