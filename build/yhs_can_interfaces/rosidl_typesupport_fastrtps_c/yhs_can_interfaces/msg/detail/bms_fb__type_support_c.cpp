...
#include "yhs_can_interfaces/msg/detail/bms_fb__rosidl_typesupport_fastrtps_c.h"
...
using _BmsFb__ros_msg_type = yhs_can_interfaces__msg__BmsFb;
...
static uint32_t _BmsFb__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yhs_can_interfaces__msg__BmsFb(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yhs_can_interfaces__msg__BmsFb;
    is_plain =
      (
...
static size_t _BmsFb__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yhs_can_interfaces__msg__BmsFb(
