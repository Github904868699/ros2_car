  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: io_fb_low_power_enable
  {
    cdr << (ros_message->io_fb_low_power_enable ? true : false);
  }

  // Field name: io_fb_low_power_state
  {
    cdr << (ros_message->io_fb_low_power_state ? true : false);
  }
  ...
  // Field name: io_fb_low_power_ratio
  {
    cdr << ros_message->io_fb_low_power_ratio;
  }
  ...
  // Field name: io_fb_charger_sign
  {
    cdr << (ros_message->io_fb_charger_sign ? true : false);
  }

  // Field name: io_fb_joypad_first
  {
    cdr << (ros_message->io_fb_joypad_first ? true : false);
  }

  // Field name: io_fb_joypad_online
  {
    cdr << (ros_message->io_fb_joypad_online ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: io_fb_low_power_enable
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->io_fb_low_power_enable = tmp ? true : false;
  }
  ...
  // Field name: io_fb_low_power_state
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->io_fb_low_power_state = tmp ? true : false;
  }
  ...
  // Field name: io_fb_charger_sign
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->io_fb_charger_sign = tmp ? true : false;
  }
  ...
  // Field name: io_fb_joypad_first
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->io_fb_joypad_first = tmp ? true : false;
  }
  ...
  // Field name: io_fb_joypad_online
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->io_fb_joypad_online = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name io_fb_low_power_enable
  {
    size_t item_size = sizeof(ros_message->io_fb_low_power_enable);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name io_fb_low_power_state
  {
    size_t item_size = sizeof(ros_message->io_fb_low_power_state);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name io_fb_lower_beam_headlamp
  ...
  // field.name io_fb_low_power_ratio
  {
    size_t item_size = sizeof(ros_message->io_fb_low_power_ratio);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name io_fb_fl_impact_sensor
  ...
  // field.name io_fb_charger_sign
  {
    size_t item_size = sizeof(ros_message->io_fb_charger_sign);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name io_fb_joypad_first
  {
    size_t item_size = sizeof(ros_message->io_fb_joypad_first);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name io_fb_joypad_online
  {
    size_t item_size = sizeof(ros_message->io_fb_joypad_online);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, io_fb_joypad_online) +
      last_member_size
      ) == ret_val;
  }
