...
#include "yhs_can_interfaces/msg/detail/steering_ctrl_fb__rosidl_typesupport_fastrtps_c.h"
...
using _SteeringCtrlFb__ros_msg_type = yhs_can_interfaces__msg__SteeringCtrlFb;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SteeringCtrlFb__ros_msg_type * ros_message = static_cast<const _SteeringCtrlFb__ros_msg_type *>(untyped_ros_message);
  // Field name: steering_ctrl_fb_gear
  {
    cdr << ros_message->steering_ctrl_fb_gear;
  }

  // Field name: steering_ctrl_fb_lrspeed
  {
    cdr << ros_message->steering_ctrl_fb_lrspeed;
  }

  // Field name: steering_ctrl_fb_rfspeed
  {
    cdr << ros_message->steering_ctrl_fb_rfspeed;
  }

  // Field name: steering_ctrl_fb_steering
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SteeringCtrlFb__ros_msg_type * ros_message = static_cast<_SteeringCtrlFb__ros_msg_type *>(untyped_ros_message);
  // Field name: steering_ctrl_fb_gear
  {
    cdr >> ros_message->steering_ctrl_fb_gear;
  }
...
static uint32_t _SteeringCtrlFb__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yhs_can_interfaces__msg__SteeringCtrlFb(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yhs_can_interfaces__msg__SteeringCtrlFb;
    is_plain =
      (
...
static size_t _SteeringCtrlFb__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yhs_can_interfaces__msg__SteeringCtrlFb(
...
static message_type_support_callbacks_t __callbacks_SteeringCtrlFb = {
...
static rosidl_message_type_support_t _SteeringCtrlFb__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SteeringCtrlFb,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yhs_can_interfaces, msg, SteeringCtrlFb)() {
  return &_SteeringCtrlFb__type_support;
}
