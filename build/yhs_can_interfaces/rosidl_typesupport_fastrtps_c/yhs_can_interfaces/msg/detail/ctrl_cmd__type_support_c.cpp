  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: ctrl_cmd_x_linear
  {
    cdr << ros_message->ctrl_cmd_x_linear;
  }

  // Field name: ctrl_cmd_z_angular
  {
    cdr << ros_message->ctrl_cmd_z_angular;
  }

  // Field name: ctrl_cmd_y_linear
  {
    cdr << ros_message->ctrl_cmd_y_linear;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name ctrl_cmd_x_linear
  {
    size_t item_size = sizeof(ros_message->ctrl_cmd_x_linear);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name ctrl_cmd_z_angular
  {
    size_t item_size = sizeof(ros_message->ctrl_cmd_z_angular);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name ctrl_cmd_y_linear
  {
    size_t item_size = sizeof(ros_message->ctrl_cmd_y_linear);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, ctrl_cmd_y_linear) +
      last_member_size
      ) == ret_val;
  }
