...
bool yhs_can_interfaces__msg__io_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // io_cmd_low_power_enable
    PyObject * field = PyObject_GetAttrString(_pymsg, "io_cmd_low_power_enable");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->io_cmd_low_power_enable = (Py_True == field);
    Py_DECREF(field);
  }
  ...
  {  // io_cmd_low_power_ratio
    PyObject * field = PyObject_GetAttrString(_pymsg, "io_cmd_low_power_ratio");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->io_cmd_low_power_ratio = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * yhs_can_interfaces__msg__io_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {  // io_cmd_low_power_enable
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->io_cmd_low_power_enable ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "io_cmd_low_power_enable", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // io_cmd_low_power_ratio
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->io_cmd_low_power_ratio);
    {
      int rc = PyObject_SetAttrString(_pymessage, "io_cmd_low_power_ratio", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
