...
bool yhs_can_interfaces__msg__bms_flag_fb__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yhs_can_interfaces.msg._bms_flag_fb.BmsFlagFb", full_classname_dest, 45) == 0);
  }
  yhs_can_interfaces__msg__BmsFlagFb * ros_message = _ros_message;
  {  // bms_flag_fb_soc
  ...
  {  // bms_flag_fb_heating_flag
    PyObject * field = PyObject_GetAttrString(_pymsg, "bms_flag_fb_heating_flag");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->bms_flag_fb_heating_flag = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * yhs_can_interfaces__msg__bms_flag_fb__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yhs_can_interfaces.msg._bms_flag_fb");
  ...
  {  // bms_flag_fb_heating_flag
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->bms_flag_fb_heating_flag ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "bms_flag_fb_heating_flag", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
